void ApplySettings()
{
	...
	cut1_a = -0.996; cut1_c = -0.945; cut1_si = 0.20;
	cut2_a = -0.996; cut2_c = -0.945; cut2_si = 0.20;
	cut3_a = -1.175; cut3_c = -0.592; cut3_si = 0.15;
	cut4_a = -1.175; cut4_c = -0.592; cut4_si = 0.15;
