void ApplySettings()
{
	...
	cut1_a = -0.997; cut1_c = -0.954; cut1_si = 0.20;
	cut2_a = -0.997; cut2_c = -0.954; cut2_si = 0.20;
	cut3_a = -1.176; cut3_c = -0.640; cut3_si = 0.15;
	cut4_a = -1.176; cut4_c = -0.640; cut4_si = 0.15;
