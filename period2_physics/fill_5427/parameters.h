void ApplySettings()
{
	...
	cut1_a = -0.996; cut1_c = -0.922; cut1_si = 0.20;
	cut2_a = -0.996; cut2_c = -0.922; cut2_si = 0.20;
	cut3_a = -1.169; cut3_c = -0.555; cut3_si = 0.15;
	cut4_a = -1.169; cut4_c = -0.555; cut4_si = 0.15;
